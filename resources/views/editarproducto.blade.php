...
<section>
    ...
    <article>
        <form class="form-group"  action="/products/update/{{ $products->id }}" method="POST">
            {{ csrf_field() }}
        ...
        <input name="photopath_slot1" value= "{{$products->photopath_slot1}}" id="photopath_slot1" type="file" />
        ...
        <input type="text" value="{{ $products->name }}" name="name" id="name" placeholder="Elija un nombre" require>
        <br><br>
        ...
        <br><br>
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="number" value="{{ $products->price }}" name="price" id="price" placeholder ="$0"require>
                </div>
                <div class="col-sm-6">
                    <label class="custom-file-label" for="stock"><i class="fas fa-boxes"></i>&nbsp;Cantidad:</label>
                    <input type="number" value="{{ $products->stock }}" name="stock" id="stock" placeholder ="0"require>
                </div>
            
            </div>
        <br>
        <label for="description"><i class="fas fa-edit"></i>&nbsp;Descripción de Producto</label>
        <textarea name="description" id="description" cols="30" rows="10">{{ $products->description }}</textarea>
