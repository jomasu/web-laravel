    ...
    <article>
        <form class="form-group"  action="{{ route('agregar.producto') }}" method="POST">
            ...
            <div class="custom-file col-sm-3">
                ...
                <input name="photopath_slot{{$i}}" id="file-input{{$i}}" type="file" />
            ...
            <input type="text" name="name" id="name_product" placeholder="Elija un nombre">
            <br><br>
            <select id="categoria" class="custom-select" name="categorie_id">
                <option selected name="categorie_id" disabled>Seleccionar una categoría</option>
            ...
            <textarea name="description" id="description_product" cols="30" rows="10"></textarea>
